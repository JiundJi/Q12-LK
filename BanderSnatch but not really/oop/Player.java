...
public class Player {
    ...
    public String getTime() {
        if (min <= 9) {return (String) (hour + ":0" + min);}
        else {return (String) (hour + ":" + min);}
    }
    ...
    public void addHour     (int newValue) {hour += newValue; if (hour == 24) {hour -= 0; day++;}}
    public void addMin      (int newValue) {min += newValue; if (min >= 60) {min -= 60; hour++;}}
